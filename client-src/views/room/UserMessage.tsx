...
export default function UserMessage({ name, frog, hat, image }: UserMessageProps) {
  return (
    <li className="mx-auto my-4 border-2 border-blue-800 flex gap-4 w-fit h-full bg-blue-500/30 backdrop-blur-lg rounded p-4">
      ...
      <img src={image} className="bg-white" />
    </li>
  );
}
